  ...
  return (
    <div className="dashboard-container">
      <style>{`
        ...
        .stat-card { background: white; padding: 20px; border-radius: 20px; border: 1px solid #e2e8f0; transition: 0.3s ease; display: flex; align-items: center; gap: 20px; }
        .stat-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.05); }
        .icon-box { width: 50px; height: 50px; border-radius: 12px; background: #f0fdf4; color: #15803d; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; }
        ...
        .btn-dash { padding: 18px; border-radius: 15px; font-weight: 700; cursor: pointer; transition: 0.2s; border: none; font-size: 0.9rem; text-align: left; display: flex; flex-direction: column; gap: 5px; }
      ...
      <div className="lower-dashboard-grid" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '30px', marginTop: '40px' }}>
        ...
        <div className="card-custom" style={{ background: 'white', padding: '30px', borderRadius: '20px', border: '1px solid #e2e8f0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <h5 style={{ color: '#043927', fontWeight: 800, margin: 0 }}>Recently Registered</h5>
          </div>
